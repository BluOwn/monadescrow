...
export const EscrowCardSkeleton: React.FC<SkeletonProps> = ({ count = 1 }) => {
  return (
    <>
      {[...Array(count)].map((_, index) => (
        <Card className="mb-3" key={`skeleton-card-${index}`}>
          <Card.Header>
...
export const EscrowDetailsSkeleton: React.FC = () => {
  return (
...
export const CreateEscrowFormSkeleton: React.FC = () => {
  return (
    <Card>
      <Card.Body>
        <Placeholder as={Card.Title} animation="glow">
